    ...
    <div class="limiter" id="loginForm">
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <!--LOGIN IMG-->
                <div class="login100-more" id="img" style="background-image: url('images/bg-02.jpg');">
                </div>

                <!--LOGIN FORM-->
                <form style="padding-top:95px" class="login100-form validate-form">
                <div class="container" style="display:center;text-align:center; padding-bottom:8px;">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                        <input class="input100" id="admin" type="text" name="admin">
