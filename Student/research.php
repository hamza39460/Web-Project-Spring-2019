...
<body>
    ...
    $result = $db->execSelectQuery("Select Teacher,Name,Details from supervision where Student='$usr'");
    ?>
            ...
            <div class="wrap-request">
                <form class="request-form">
                    ...
                    <div class="wrap-input2 validate-input" data-validate="Name is required">
                        <input tabindex="1" class="input2 has-val" id="projName" id="inputForm" type="text" name="name" disabled>
                            ...
                            <tr class="container-login100-form-btn container-request-form-btn">
                                <td class="container-login100-form-btn container-request-form-btn">
                                    <div class="login100-form-btn">
                                        ...
                                        <input tabindex="5" type="button" value="Submit Request" id="btnSendRequest1" class="login100-form-btn">
                                    </div>
                                </td>
                                <td class="container-login100-form-btn container-request-form-btn">
                                    <div class="login100-form-btn">
                    ...
                    <div class="table100">
                        <table class="table1">
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <tbody>
                                    <tr class="tr">
                                        <td class="email"><?php echo $row["Teacher"] ?></td>
                                        <td class="name"><?php echo $row["Name"] ?></td>
                                        <td class="details"><?php echo $row["Details"] ?></td>
                                        <td><span class="sendPaper"> <i class="fa fa-paper-plane"></i></span></td>
                                    </tr>
                                </tbody>
                            <?php
                        }
